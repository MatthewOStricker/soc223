...
I see that this chart is providing a decent visualization of the number of the streamers' followers from the dataset. There a few big residuals that are sprinkled on the chart like the twitch streamer that is close to the `log(followers)` value of 4.
...
Arabic and Spanish have the highest average viewers out of all the languages. On the lower end of the spectrum were Swedish, Finnish, Thai, and Czech.
