...
For my final project, I plan to answer the research question "What impact did the COVID-19 pandemic have on voter registration in the United States between January-February and March-April in 2020?". To answer the question, I plan to use the `voter_registration` dataset from fivethirtyeight and the `covid_cases` dataset that has the covid cases recorded in 2020 in the United States from Our World in Data to analyze the voter registration numbers for each state.
...
In order to conduct effective regression and residual analysis, I plan to use the state of Florida as a key example for that portion of my final project. Since Florida was the state with the most data accessible, it will serve as the example that can serve as the answer to the research question. I specified my research question to focus on Florida for this reason and hope the answer can potentially serve as the foundation for any future research questions and analysis that takes place in other states during 2020.
