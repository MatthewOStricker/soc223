...
As noticed in Figure 5, both regression lines are essentially parallel and positively sloped to a degree, which implies a positive relationship and a consistency of the independent and dependent variables across both categories of the Post-COVID variable.
