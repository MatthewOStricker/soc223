...
**Answer:** There is a positive correlation of .582 between number of rides and what the temperature feels like in Fahrenheit.
...
**Answer:** There is a negative correlation of -.195 between number of rides and the wind speed in miles per hour.
...
**Answer:** For the first regression (wind in mph), it shows that each 1 mph increase in wind speed produces 56 fewer bike rides. For the second regression (wind in kph), it shows that each 1 kph increase in wind speed produces 34 fewer bike rides.
...
**Answer:** The predicted ridership if the wind is blowing at 20 KPH would be 3515 rides.
...
**Answer:** The predicted ridership if the wind is blowing at 20 MPH would be 3095 rides (rounded to nearest tenth).
