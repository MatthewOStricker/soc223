...
-   what does each row represent?
    -   **Answer:** Each row represents a day.
-   what dates does the dataset cover?
    -   **Answer:** It covers dates from 01/01/2011 to 12/31/2012.
-   what is the highest observed ridership in the dataset?
    -   **Answer:** Highest observed ridership in the dataset is 6,946.
-   what was the highest wind speed recorded in the dataset?
    -   **Answer:** Highest wind speed recorded in the dataset is 34.00002.
...
**Answer:** There is a positive correlation of .582 (rounded to the nearest thousandth) between number of rides and what the temperature feels like in Fahrenheit.
...
**Answer:** There is a negative correlation of -.195 (rounded to the nearest thousandth) between number of rides and the wind speed in miles per hour.
...
**Answer:** The correlation between wind speed in MPH is one, and the correlation between wind speed in KPH is also one. This is due to the fact that the two variables are the same.
...
**Answer: (Rounded to the nearest whole number)** For the first regression (wind in mph), it shows that each 1 mph increase in wind speed produces 56 fewer bike rides. For the second regression (wind in kph), it shows that each 1 kph increase in wind speed produces 34 fewer bike rides.
...
**Answer: (Rounded to the nearest whole number)** The predicted ridership if the wind is blowing at 20 KPH would be 3515 rides.
...
**Answer: (Rounded to the nearest whole number)** The predicted ridership if the wind is blowing at 20 MPH would be 3095 rides (rounded to nearest tenth).
...
**Answer:** When it is true that it is the weekend, the model expects the ridership to decrease by 714 rides (rounded to the nearest tenth.)
...
**Answer:** The date with the *largest absolute residual* was 10/29/2012 with a residual of -3490.348. When I looked that day up, I saw that it was the same day as Hurricane Sandy hitting the United States. The harsh weather that likely appeared at Washington D.C. drastically reduced the amount of people riding bikes on that day to 20.
